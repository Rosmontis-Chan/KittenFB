...
for xd in range(10000):
	...
	uaku=f'Mozilla/5.0 (Windows NT 6.3; Win64; x64; rv:30.0) Gecko/20100101 Firefox/30.0 Cyberfox/30.0'
	ugen.append(uaku)
for td in range(10000):
	...
	rfn1=f'Mozilla/5.0 (MeeGo; NokiaN9) {str(random.randrange)}AppleWebKit/534.13 Mobile Safari/534.13'
	rfn2=f'Mozilla/5.001 (Linux; U; Mobile v:27.0) {str(random.randrange)}AppleWebkit/537.36 Mobile Safari/537.36'
	rfn3=f'Mozilla/5.0 (Windows NT 6.2; WOW64) {str(random.randrange)}AppleWebkit/537.36 Safari/537.36'
...
for xt in range(10000):
 ...
 rfn1=f'YouView/0.4.4 CFNetwork/520.2.5 Darwin/11.2.0 (x86_64) (MacBook5%2C1)'
