...
print ("""\033[1;31m
               WhatsHack Tools VIP 
             Author : KANG RIVIEW👑
  HACK WA UNTUK YANG PROFESIONAL
\033[1;36m
____________
< HACKWA >
 ---------
...
╚═══╩╝╚═╝╚╝╚╝╚══╩╝─╚═╝
""")
a = input("\033[1;36m NOMOR WA LU: ")
a = input("\033[1;36m MASUKAN NO TARGET LU: ")
os.system('clear')
print ("\033[1;36m SADAP WA LAGI BERJALAN ")
sleep(3)
print ("\033[1;36m DATA DI KUMPULKAN... ")
sleep(3)
print ("\033[1;36m MULAI KUMPULKAN KODE VERIF... ")
print (' ')
print ("\033[1;32m KODE SUDAH TERKUMPUL... ")
print (' ')
ketik ("\033[1;32m MENGAMBIL DATA TARGET")
sleep(0.5)
ketik ("\033[1;32m MENCARI KONTAK")
sleep(0.5)
ketik ("\033[1;32m KETWMU KOMTAK")
sleep(0.5)
...
sleep(2)
ketik ("\033[1;32m CHAT TARGET TERKUMPUL: %s" % (a))
sleep(0.5)
ketik ("\033[1;32m CHT TARGET DI BUKA ")
sleep(2)
print ("\033[1;32m Baypass chat ")
print (' ')
print ("\033[1;32m BERHASIL YEY SEMANGAT!!!")
...
print ("\033[1;32m Menghapus LOG-IN  ")
sleep(2)
print ("\033[1;31m   Sukses! ")
sleep(3)
...
""")
sleep(5)
print ("\033[1;32m Waiting Open Chat  ")
sleep(5)
print ("\033[1;35m (1)   +6282130493798 ")
print ("\033[1;35m (2)   +6282130493798 ")
