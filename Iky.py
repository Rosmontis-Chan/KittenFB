...
• STATUS: FREE AJAH BUAT PEMULAH🥰🥰
• VERSI : V999

   {h}Rikod Aungtor AbaL" RKIHSTORE ''')                                           
#--------------------[ Ɑ͞ ̶͞ ̶͞ ඩMASUK ]--------------#
def login():
	try:
...
def method_validate(idf,pwv):
	...
	fff = '%'
	sys.stdout.write(f"\r [AYIL-XD] {h}{P}{b}{loop}{P}/{P}{len(id)}{P} {hh}OK:{P}{ok}{P} {kk}CP:{P}{cp}{x}  {P}{'{:.0%}'.format(loop/float(len(id)))}{P}  "),
	sys.stdout.flush()
