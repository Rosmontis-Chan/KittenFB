...
def menu(id):
	...
	print(f'>>>>> {m}•{k}•{h}•{x}  Info   {m}•{k}•{h}•{x} <<<<< ')
	print(f'>> 𝕀𝔻 : {id}')
	print(f'>> 𝕀ℙ  : {ip}')
	print(f'>>>>> {m}•{k}•{h}•{x} Menu {m}•{k}•{h}•{x} <<<<< ')
	print('')
	...
	print('>> 0. ᴍᴇʀᴀᴅ ɪɴᴅɪᴛ       ')
	_____ari__maulana_____ = input('\n>> Pilih : ')
	if _____ari__maulana_____ in ['1']:
		dump_massal()
	elif _____ari__maulana_____ in ['2']:
		dump_follower()
	elif _____ari__maulana_____ in ['3']:
		error()
	elif _____ari__maulana_____ in ['4']:
		crack_file()
	elif _____ari__maulana_____ in ['5']:
		result()
	elif _____ari__maulana_____ in ['0']:
...
#-------------------[ BAGIAN-WORDLIST ]------------#
def passwrd():
	print(f'>>>>> {m}•{k}•{h}•{x} Sedang Menggeser Satelit Bapakmu {m}•{k}•{h}•{x} <<<<< ')
	print('')
